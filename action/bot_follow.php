...
$kun = new System;
        ...
        $result = mysqli_query($kun->connect_db(), "SELECT * FROM `bot_follow` WHERE `username`='".$_SESSION['username']."'");
...
<div class="card card-default mb-4 mb-lg-5">
										<div class="card-header card-header-border-bottom">
											<h2><center>Bot Follow Tiktok</center></h2>
										</div>
...
<center>
											...
											<p class="card-text text-center mb-3">Click vào công tắc để bật hoặc tắt bot follow. </p>
...
$(document).ready(function(){
	...
	var checkbox = $('input[id="option"]'); 
  	...
  	send_action(checked, 'bot_follow');
